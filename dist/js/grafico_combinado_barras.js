...
*/
function inicializa() {
    if (LOG_DEBUG_GRAFICO_COMBINADO_BARRAS) {
        console.log('[combinado_barras] [inicializa]');
    }
...
function inicializaMultidioma() {
    if (LOG_DEBUG_GRAFICO_COMBINADO_BARRAS) {
        console.log('[combinado_barras] [inicializaMultidioma]');
    }
    ...
    // $.i18n.debug = LOG_DEBUG_GRAFICO_COMBINADO_BARRAS;
}
...
function inicializaDatos() {
    if (LOG_DEBUG_GRAFICO_COMBINADO_BARRAS) {
        console.log('[combinado_barras] [inicializaDatos]');
    }
...
function obtieneDatosAPI(url) {
    if (LOG_DEBUG_GRAFICO_COMBINADO_BARRAS) {
        console.log('[combinado_barras] [obtieneDatosAPI] [URL] ' + url);
    }
...
function insertaURLSAPI(urljson, urlcsv) {
    if (LOG_DEBUG_GRAFICO_COMBINADO_BARRAS) {
        console.log('[combinado_barras] [insertaURLSAPI]');
    }
...
/*
    Función que comprueba y captura si se han pasado parámetros a la web, en caso de haberlos ejecutará una búsqueda 
    con ellos.
*/
function capturaParam() {
    if (LOG_DEBUG_GRAFICO_COMBINADO_BARRAS) {
        console.log('[combinado_barras] [capturaParam]');
    }
...
function pintaGrafico() {
    if (LOG_DEBUG_GRAFICO_COMBINADO_BARRAS) {
        console.log('[combinado_barras] [pintaGrafico]');
    }
...
function createSeries(name, data) {
    if (LOG_DEBUG_GRAFICO_COMBINADO_BARRAS) {
        console.log('[combinado_barras] [createSeries] [name] ' + name);
    }
...
function mostrarDatos() {
    if (LOG_DEBUG_GRAFICO_COMBINADO_BARRAS) {
        console.log('[combinado_barras] [mostrarDatos]');
    }
...
function addFiltro(paramValor, campo) {
    if (LOG_DEBUG_GRAFICO_COMBINADO_BARRAS) {
        console.log(
            '[combinado_barras] [addFiltro] [paramValor:' +
            paramValor +
            '] [campo:' +
            campo +
            ']'
    ...
    if (LOG_DEBUG_GRAFICO_COMBINADO_BARRAS) {
        console.log(
            '[combinado_barras] [addFiltro] [filtro:' +
            filtro +
            ']'
        );
    }
